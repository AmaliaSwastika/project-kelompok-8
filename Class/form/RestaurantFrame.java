...
public class RestaurantFrame extends javax.swing.JFrame {
    ...
    public RestaurantFrame() {
     ...
     private void initTable() {
        ...
        model.addColumn("Ayam Bakar");
        model.addColumn("Ikan Goreng");
        model.addColumn("Sushi");
        model.addColumn("Tongseng");
        model.addColumn("Es Teh");
        model.addColumn("Jus Alpukat");
        model.addColumn("Thai Tea");
        model.addColumn("Matcha");
